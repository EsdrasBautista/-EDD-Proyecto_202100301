...
void listaAmistad::verLista(){
    ...
    if(head == nullptr){
        std::cout << "sin amigos xd" << std::endl;
        return;
    }
    while(nodoActual != nullptr){
        std::cout << nodoActual->getCorreoA() << std::endl;
...
void listaAmistad::eliminarAmigo(string correo){
    ...
    if(nodoActual != nullptr){
        if(anterior == nullptr){ //si es el primero en la lista
        ...
        std::cout << "Amigo con correo " << correo << " no encontrado en la lista." << std::endl;
    }
...
bool listaAmistad::verificarAmistad(string correo){
